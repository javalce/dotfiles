...
```bash
# Using curl
curl -fsSL https://raw.githubusercontent.com/javalce/dotfiles/main/installer | bash

# Using wget
wget -qO- https://raw.githubusercontent.com/javalce/dotfiles/main/installer | bash
```
